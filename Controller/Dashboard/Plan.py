...
ActivityPlan_Blueprint = CommonModule.flask.Blueprint(
    'ActivityPlan_Blueprint', import_name=__name__)

@ActivityPlan_Blueprint.route('/getActivityPlans', methods=['POST','GET'])
...
@ActivityPlan_Blueprint.route('/getActivityPlans/complete', methods=['POST','GET'])
def didActivity():
    session = Session()
    try:
...
@ActivityPlan_Blueprint.route('/getActivityPlans/uploadVideo', methods=['POST','GET'])
